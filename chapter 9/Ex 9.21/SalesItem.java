...
public class SalesItem
{
    ...
    public Comment findMostHelpfulComment()
    {
        ...
        Comment best = comments.stream().sorted(x,y)->Integer.compare(x.getVoteCount(),
        y.getVoteCount()).findAny().orElse(null);
        return best;
    }
    ...
    {
        Comment result = comments.stream().filter(
        comment -> comment.getAuthor().equals(author)).
        findAny().orElse(null);
        return result;
    }
