...
public class SalesItemTest
{
    ...
    {
        SalesItem salesIte1 = new SalesItem("Become a Java Guru", 9999);
        assertEquals(true, salesIte1.addComment("Joe", "Very helpful", 5));
        assertEquals(true, salesIte1.addComment("Mike", "Too long didn't read", 1));
    ...
    @Test
    public void testPrintInfoPrice()
    {
        SalesItem salesIte1 = new SalesItem("Super coder", 9999);
        salesIte1.showInfo();
        assertEquals(9999, salesIte1.getPrice());
    }

    @Test
    public void testNumberOfComments()
    {
        SalesItem salesIte2 = new SalesItem("Something cool", 1000);
        assertEquals(true, salesIte2.addComment("Jake", "It wasn't very cool", 2));
        assertEquals(true, salesIte2.addComment("Ian", "It was sorta neat", 3));
