...
public class MusicOrganizer
{
    ...
    // This allows random track method to work
    ...
    /**
     * Shuffles all tracks in organizer and plays each one once.
     */
   public void randomAllTracks() {
    ...
    /**
     * A Private method called to build a shuffled playlist.
     */
...
public void playList(ArrayList<Track> playList) {
    ...
    /**
     * Delete all tracks containing the search
     * It will search the for tracks containing the string and
     * then delete the ones that do
     */
    public void deleteTracksContaining( String item){
        for( Track track: tracks){
            if (track.getTitle().contains(item)){
                tracks.remove(track);           
            }
        }
    }
